...
public class MyLinkedListTester {
	...
	public void testAddEnd()
	{
		...
		assertEquals("AddEnd: check a is correct ", true, state);
		assertEquals("AddEnd: check element 0 is correct ", (Integer)1, emptyList.get(1));
	...
	public void testSet()
	{
		...
		try {
			longerList.add(12, 12);
			fail("Check out of bounds.");
		}
		catch (IndexOutOfBoundsException e) {
			
		}
		assertEquals("testSet: check value is correct ", (Integer)10, longerList.get(2));
		assertEquals("testSet: check value is correct ", 10, longerList.size());
	}
