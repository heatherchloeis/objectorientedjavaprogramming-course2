...
public abstract class Document {
	...
	protected static int countSyllables(String word)
	{
		...
		for (int i = 0; i < cArray.length; i++) {
			if (i == cArray.length-1 && Character.toLowerCase(cArray[i]) == 'e' && newSyllable && syllables > 0) {
				syllables--;
			}
	...
	public double getFleschScore()
	{
	    ...
	    double score = 206.835 - (1.015 * (wordCount / getNumSentences())) - (84.6 * ((double)getNumSyllables() / wordCount));
	    return score;
	}
