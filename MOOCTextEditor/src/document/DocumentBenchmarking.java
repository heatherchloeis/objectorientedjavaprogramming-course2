...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			double timeBD = (endTimeBD - startTimeBD) / 1000000000.0;
			System.out.print(timeBD);
			System.out.print('\t');
			long startTimeED = System.nanoTime();
			for (int trial = 0; trial < trials; trial++) {
				EfficientDocument ed = new EfficientDocument(readFile);
				double score = ed.getFleschScore();
			}
			long endTimeED = System.nanoTime();
			double timeED = (endTimeED - startTimeED) / 1000000000.0;
			System.out.print(timeED);
			System.out.print('\n');
